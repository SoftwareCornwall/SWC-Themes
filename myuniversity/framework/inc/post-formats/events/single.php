...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'sd-blog-entry sd-standard-entry sd-course-entry clearfix' ); ?>> 
	...
	<div class="sd-events-page">
		...
		<?php if ( $sd_data['sd_events_single_prev_next'] == '1' ) : ?>
				<footer>
					<div class="sd-prev-next-post clearfix">
						<span class="sd-prev-post">	<?php next_post_link( '%link', '&larr; ' . $sd_data['sd_events_single_prev'] ); ?> </span>
						<span class="sd-next-post">	<?php previous_post_link( '%link', $sd_data['sd_events_single_next'] .  ' &rarr;' ); ?> </span>
					</div>
				</footer>
			<?php endif; ?>
	</div>
