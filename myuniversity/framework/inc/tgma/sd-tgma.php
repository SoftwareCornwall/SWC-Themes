	...
	function sd_required_plugins() {
			$plugins = array(
				...
				array(
					'name'     				=> 'Posts 2 Posts',
					'slug'     				=> 'posts-to-posts',
					'source'   				=> get_template_directory_uri() . '/framework/plugins/posts-to-posts.zip',
					'required' 				=> true,
					'version' 				=> '',
					'force_activation' 		=> false,
					'force_deactivation' 	=> false,
				...
				array(
					'name'     				=> 'SD Theme Functions',
					'slug'     				=> 'sd-theme-functions',
					'source'   				=> get_template_directory_uri() . '/framework/plugins/sd-theme-functions.zip',
					'required' 				=> true,
					'version' 				=> '',
					'force_activation' 		=> false,
					'force_deactivation' 	=> false,
