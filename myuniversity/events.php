...
<div class="sd-blog-page">
	<div class="container">
		<div class="row"> 
			<!--left col-->
			<div class="col-md-<?php if ( $sd_data['sd_events_layout'] == '2' ) echo '12'; else echo '8'; ?> <?php if ( $sd_data['sd_sidebar_location'] == '2' ) echo 'pull-right'; ?>">
	...
	?>
					...
					<?php if ( $sd_data['sd_pagination_type'] == '1' ) : ?>
						...
						<div class="sd-nav-previous">
							<?php previous_posts_link( $sd_data['sd_events_prev'] ); ?>
						</div>
						<?php endif; ?>
						<?php if ( get_next_posts_link() ) : ?>
						<div class="sd-nav-next">
							<?php next_posts_link( $sd_data['sd_events_next'] ); ?>
						</div>
						<?php endif; ?>
			...
			<!--left col end--> 
			<?php if ( $sd_data['sd_events_layout'] !== '2' ) : ?>
			<!--sidebar-->
			<div class="col-md-4">
				<?php get_sidebar(); ?>
			</div>
