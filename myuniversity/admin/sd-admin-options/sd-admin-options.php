...
if (!class_exists('SD_Redux_Framework_config')) {
    ...
    class SD_Redux_Framework_config {
        ...
        public function setSections() {
			...
			$this->sections[] = array(
                ...
                'fields'    => array(
					...
					array(
                            'id'       => 'sd_courses_next',
                            'type'     => 'text',
                            'title'    => __( 'Next Courses', 'sd-framework' ),
                            'subtitle' => __( 'Next courses button text.', 'sd-framework' ),
                            'default'  => 'Next Courses',
							'required'  => array('sd_pagination_type', "=", 1)
                        ),
					array(
                            'id'       => 'sd_courses_prev',
                            'type'     => 'text',
                            'title'    => __( 'Previous Courses', 'sd-framework' ),
                            'subtitle' => __( 'Previous courses button text.', 'sd-framework' ),
                            'default'  => 'Previous Courses',
							'required'  => array('sd_pagination_type', "=", 1)
                        ),
					array(
                            'id'       => 'sd_events_next',
                            'type'     => 'text',
                            'title'    => __( 'Next Events', 'sd-framework' ),
                            'subtitle' => __( 'Next events button text.', 'sd-framework' ),
                            'default'  => 'Next Events',
							'required'  => array('sd_pagination_type', "=", 1)
                        ),
					array(
                            'id'       => 'sd_events_prev',
                            'type'     => 'text',
                            'title'    => __( 'Previous Events', 'sd-framework' ),
                            'subtitle' => __( 'Previous events button text.', 'sd-framework' ),
			...
			$this->sections[] = array(
                'title'     => __('Courses', 'sd-framework'),
                'desc'      => '',
                'icon'      => 'el-icon-book',
                'fields'    => array(
					
					array(
                        'id'       => 'sd_courses_page_slug',
                        'type'     => 'text',
                        'title'    => __( 'Courses Slug', 'sd-framework' ),
                        'subtitle' => __( 'Rename the slug of the courses.', 'sd-framework' ),
						'desc' => __( 'After making changes to this field make sure you go to Settings > Permalinks and hit "Save Changes" to prevent any 404 errors.', 'sd-framework' ),
                        'default'  => 'courses-page',
                    ),	
					array(
                        'id'       => 'sd_courses_layout',
                        'type'     => 'select',
                        'title'    => __( 'Courses Layout', 'sd-framework' ),
                        'subtitle' => __( 'Select the layout for the courses pages.', 'sd-framework' ),
						'desc' => __( 'This includes courses page, single courses posts and courses archive pages.', 'sd-framework' ),
                        'options'  => array(
                        	'1' => 'With Sidebar',
                            '2' => 'Full Width'
                         ),
					...
					array(
                        'id'        => 'sd_courses_featured_img',
                        'type'      => 'switch',
                        'title'     => __('Featured Image', 'sd-framework'),
                        'subtitle'  => __('Enable or disable the featured image for courses posts.', 'sd-framework'),
                        'default'   => true,
						'on'        => __('Enabled', 'sd-framework'),
                        'off'       => __('Disabled', 'sd-framework')
                    ),
					array(
                        'id'        => 'sd_courses_post_meta_enable',
                        'type'      => 'switch',
                        'title'     => __('Courses Post Meta', 'sd-framework'),
                        'subtitle'  => __('Enable or disable the courses post meta.', 'sd-framework'),
                        'default'   => true,
						'on'        => __('Enabled', 'sd-framework'),
                        'off'       => __('Disabled', 'sd-framework')
                    ),
					array(
                            'id'       => 'sd_courses_post_meta',
                            'type'     => 'checkbox',
                            'title'    => __( 'Courses Post Meta Options', 'sd-framework' ),
                            'subtitle' => __( 'Select what info do you want to display for the course meta.', 'sd-framework' ),
							'desc' => __( 'This info appears right under the featured image.', 'sd-framework' ),
                            'options'  => array(
                                '1' => __( 'ID', 'sd-framework' ),
								'2' => __( 'Discipline', 'sd-framework' ),
                                '3' => __( 'Study level', 'sd-framework' ),
                                '4' => __( 'Course length', 'sd-framework' ),
								'5' => __( 'Course location', 'sd-framework' ),
								'6' => __( 'Professor', 'sd-framework' )
                            ),
                            'default'  => array(
                                '1' => '1',
                                '2' => '1',
							...
							'required'  => array('sd_courses_post_meta_enable', "=", 1)
                        ),
					array(
                        'id'        => 'sd_courses_comments',
                        'type'      => 'switch',
                        'title'     => __('Courses Comments', 'sd-framework'),
                        'subtitle'  => __('Enable or disable the comments on the courses posts.', 'sd-framework'),
					...
					array(
                        	'id'        => 'sd_courses_single_prev_next',
	                        'type'      => 'switch',
    	                    'title'     => __('Next/Previous Course Links', 'sd-framework'),
        	                'subtitle'  => __('Enable or disable the next/previous links at the bottom of the course single post.', 'sd-framework'),
            	            'default'   => true,
							'on'        => __('Enabled', 'sd-framework'),
                    	    'off'       => __('Disabled', 'sd-framework')
                    	),
					array(
                            'id'       => 'sd_courses_single_next',
                            'type'     => 'text',
                            'title'    => __( 'Next Course', 'sd-framework' ),
                            'subtitle' => __( 'Next course button text.', 'sd-framework' ),
                            'default'  => 'Next Course',
							'required'  => array('sd_courses_single_prev_next', "=", 1)
                        ),
					array(
                            'id'       => 'sd_courses_single_prev',
                            'type'     => 'text',
                            'title'    => __( 'Previous Course', 'sd-framework' ),
                            'subtitle' => __( 'Previous course button text.', 'sd-framework' ),
                            'default'  => 'Previous Course',
							'required'  => array('sd_courses_single_prev_next', "=", 1)
                        ),
				),
            );
			...
			$this->sections[] = array(
                'icon'      => 'el-icon-search',
                'title'     => __('Search Courses', 'sd-framework'),
                'subsection' => true,
                'fields'    => array(
				
					array(
                        'id'        => 'sd_search_courses',
                        'type'      => 'switch',
                        'title'     => __('Search Courses', 'sd-framework'),
                        'subtitle'  => __('Enable or disable the search courses box.', 'sd-framework'),
                        'default'   => false,
						'on'        => __('Enabled', 'sd-framework'),
                        'off'       => __('Disabled', 'sd-framework')
                    ),
					array(
                            'id'       => 'sd_search_courses_results',
                            'type'     => 'select',
                            'data'     => 'pages',
                            'title'    => __( 'Course Search Results Page', 'redux-framework-demo' ),
                            'subtitle' => __( 'Select your course search resulsts page.', 'sd-framework' ),
                            'desc'     => __( 'Make sure that the selected page has the "Search Course Results" page template assigned.', 'sd-framwork' ),
                        ),
					array(
                            'id'   => 'sd_search_fields_rename_info',
                            'type' => 'info',
                            'desc' => __( '<strong>Search Fields Renaming</strong>', 'sd-framework' ),
							'required'  => array('sd_search_courses', "=", 1)
                        ),
					array(
                            'id'       => 'sd_discipline_name',
                            'type'     => 'text',
                            'title'    => $sd_all_data['sd_discipline_name'],
                            'subtitle' => __( 'Rename the field named "' . $sd_all_data['sd_discipline_name'] . '".', 'sd-framework' ),
							'desc' => __( 'Make sure you hit "Save Changes" right after you modify this field.', 'sd-framework' ),
                            'default'  => 'Discipline',
							'hint'     => array(
                                'content' => __( 'Note: The default name for this field is <strong>Discipline</strong>. This field is also a category for the professors section. Handle with care!', 'sd-framework' ),
                            ),
							'required'  => array('sd_search_courses', "=", 1)
                        ),
					array(
                            'id'       => 'sd_course_length_name',
                            'type'     => 'text',
                            'title'    => $sd_all_data['sd_course_length_name'],
                            'subtitle' => __( 'Rename the field named "' . $sd_all_data['sd_course_length_name'] . '".', 'sd-framework' ),
							'desc' => __( 'Make sure you hit "Save Changes" right after you modify this field.', 'sd-framework' ),
                            'default'  => 'Course Length',
							'required'  => array('sd_search_courses', "=", 1)
                        ),
					array(
                            'id'       => 'sd_study_level_name',
                            'type'     => 'text',
                            'title'    => $sd_all_data['sd_study_level_name'],
                            'subtitle' => __( 'Rename the field named "' . $sd_all_data['sd_study_level_name'] . '".', 'sd-framework' ),
							'desc' => __( 'Make sure you hit "Save Changes" right after you modify this field.', 'sd-framework' ),
                            'default'  => 'Study Level',
							'required'  => array('sd_search_courses', "=", 1)
                        ),
					array(
                            'id'       => 'sd_campus_location_name',
                            'type'     => 'text',
                            'title'    => $sd_all_data['sd_campus_location_name'],
                            'subtitle' => __( 'Rename the field named "' . $sd_all_data['sd_campus_location_name'] . '".', 'sd-framework' ),
							'desc' => __( 'Make sure you hit "Save Changes" right after you modify this field.', 'sd-framework' ),
                            'default'  => 'Campus Location',
							'required'  => array('sd_search_courses', "=", 1)
                        ),
					array(
                            'id'   => 'sd_search_fields_display_info',
                            'type' => 'info',
                            'desc' => __( '<strong>Fields to Display</strong>', 'sd-framework' ),
							'required'  => array('sd_search_courses', "=", 1)
                        ),
					array(
                            'id'       => 'sd_search_fields',
                            'type'     => 'checkbox',
                            'title'    => __( 'Search Fields', 'sd-framework' ),
                            'subtitle' => __( 'Select which fields to display in the search box.', 'sd-framework' ),
                            'options'  => array(
                                '1' => $sd_all_data['sd_discipline_name'],
                                '2' => $sd_all_data['sd_course_length_name'],
                                '3' => $sd_all_data['sd_study_level_name'],
								'4' => $sd_all_data['sd_campus_location_name'],
								'5' => 'Keywords'
                            ),
                            'default'  => array(
                                '1' => '1',
					...
					array(
                            'id'   => 'sd_search_fields_slugs_info',
                            'type' => 'info',
                            'desc' => __( '<strong>Courses Categories Slugs</strong>', 'sd-framework' ),
							'required'  => array('sd_search_courses', "=", 1)
                        ),
					array(
                            'id'       => 'sd_discipline_slug',
                            'type'     => 'text',
                            'title'    => $sd_all_data['sd_discipline_name'],
                            'subtitle' => __( 'Change the slug of "' . $sd_all_data['sd_discipline_name'] . '".', 'sd-framework' ),
							'desc' => __( 'After making changes to this field make sure you go to Settings > Permalinks and hit "Save Changes" to prevent any 404 errors.', 'sd-framework' ),
                            'default'  => 'course-discipline',
							'required'  => array('sd_search_courses', "=", 1)
                        ),
					array(
                            'id'       => 'sd_course_length_slug',
                            'type'     => 'text',
                            'title'    => $sd_all_data['sd_course_length_name'],
                            'subtitle' => __( 'Change the slug of "' . $sd_all_data['sd_course_length_name'] . '".', 'sd-framework' ),
							'desc' => __( 'After making changes to this field make sure you go to Settings > Permalinks and hit "Save Changes" to prevent any 404 errors.', 'sd-framework' ),
                            'default'  => 'course-length',
							'required'  => array('sd_search_courses', "=", 1)
                        ),
					array(
                            'id'       => 'sd_study_level_slug',
                            'type'     => 'text',
                            'title'    => $sd_all_data['sd_study_level_name'],
                            'subtitle' => __( 'Change the slug of "' . $sd_all_data['sd_study_level_name'] . '".', 'sd-framework' ),
							'desc' => __( 'After making changes to this field make sure you go to Settings > Permalinks and hit "Save Changes" to prevent any 404 errors.', 'sd-framework' ),
                            'default'  => 'study-level',
							'required'  => array('sd_search_courses', "=", 1)
                        ),
					array(
                            'id'       => 'sd_campus_location_slug',
                            'type'     => 'text',
                            'title'    => $sd_all_data['sd_campus_location_name'],
                            'subtitle' => __( 'Change the slug of "' . $sd_all_data['sd_campus_location_name'] . '".', 'sd-framework' ),
							'desc' => __( 'After making changes to this field make sure you go to Settings > Permalinks and hit "Save Changes" to prevent any 404 errors.', 'sd-framework' ),
			...
			$this->sections[] = array(
                'title'     => __('Events', 'sd-framework'),
                'desc'      => '',
                'icon'      => 'el-icon-bullhorn',
                'fields'    => array(
					
					array(
                        'id'       => 'sd_events_page_slug',
                        'type'     => 'text',
                        'title'    => __( 'Events Slug', 'sd-framework' ),
                        'subtitle' => __( 'Rename the slug of the events.', 'sd-framework' ),
						'desc' => __( 'After making changes to this field make sure you go to Settings > Permalinks and hit "Save Changes" to prevent any 404 errors.', 'sd-framework' ),
                        'default'  => 'events-page'
                    ),
					array(
                        'id'       => 'sd_events_layout',
                        'type'     => 'select',
                        'subtitle' => __( 'Select the layout for the events pages.', 'sd-framework' ),
						'desc' => __( 'This includes events page, single events posts and events archive pages.', 'sd-framework' ),
                        'options'  => array(
                        	'1' => 'With Sidebar',
                            '2' => 'Full Width'
                         ),
					...
					array(
                        'id'        => 'sd_events_featured_img',
                        'type'      => 'switch',
                        'title'     => __('Featured Image', 'sd-framework'),
                        'subtitle'  => __('Enable or disable the featured image for events posts.', 'sd-framework'),
                        'default'   => true,
						'on'        => __('Enabled', 'sd-framework'),
                        'off'       => __('Disabled', 'sd-framework')
                    ),
					array(
                        'id'        => 'sd_events_post_meta_enable',
                        'type'      => 'switch',
                        'title'     => __('Events Post Meta', 'sd-framework'),
                        'subtitle'  => __('Enable or disable the events post meta.', 'sd-framework'),
                        'default'   => true,
						'on'        => __('Enabled', 'sd-framework'),
                        'off'       => __('Disabled', 'sd-framework')
                    ),
					array(
                            'id'       => 'sd_events_post_meta',
                            'type'     => 'checkbox',
                            'title'    => __( 'Events Post Meta Options', 'sd-framework' ),
                            'subtitle' => __( 'Select what info do you want to display for the events meta.', 'sd-framework' ),
							'desc' => __( 'This info appears right under the featured image.', 'sd-framework' ),
                            'options'  => array(
                                '1' => 'Event hours',
                                '2' => 'Event location'
							...
							'required'  => array('sd_events_post_meta_enable', "=", 1)
                        ),
					array(
                        'id'        => 'sd_events_comments',
                        'type'      => 'switch',
                        'title'     => __('Event Comments', 'sd-framework'),
                        'subtitle'  => __('Enable or disable the comments on the events posts.', 'sd-framework'),
						'desc'  => __('While enabled this option can be overrided by the option in the WordPress editor.', 'sd-framework'),
                        'default'   => false,
						'on'        => __('Enabled', 'sd-framework'),
                        'off'       => __('Disabled', 'sd-framework')
					...
					array(
                        	'id'        => 'sd_events_single_prev_next',
	                        'type'      => 'switch',
    	                    'title'     => __('Next/Previous Event Links', 'sd-framework'),
        	                'subtitle'  => __('Enable or disable the next/previous links at the bottom of the event single post.', 'sd-framework'),
            	            'default'   => true,
							'on'        => __('Enabled', 'sd-framework'),
                    	    'off'       => __('Disabled', 'sd-framework')
                    	),
					array(
                            'id'       => 'sd_events_single_next',
                            'type'     => 'text',
                            'title'    => __( 'Next Event', 'sd-framework' ),
                            'subtitle' => __( 'Next event button text.', 'sd-framework' ),
                            'default'  => 'Next Event',
							'required'  => array('sd_events_single_prev_next', "=", 1)
                        ),
					array(
                            'id'       => 'sd_events_single_prev',
                            'type'     => 'text',
                            'title'    => __( 'Previous Event', 'sd-framework' ),
                            'subtitle' => __( 'Previous event button text.', 'sd-framework' ),
			...
			$this->sections[] = array(
                'title'     => __('Professors', 'sd-framework'),
                'desc'      => '',
                'icon'      => 'el-icon-user',
                'fields'    => array(
					
					array(
                        'id'       => 'sd_professors_page_slug',
                        'type'     => 'text',
                        'title'    => __( 'Professors Slug', 'sd-framework' ),
                        'subtitle' => __( 'Rename the slug of the professors.', 'sd-framework' ),
						'desc' => __( 'After making changes to this field make sure you go to Settings > Permalinks and hit "Save Changes" to prevent any 404 errors.', 'sd-framework' ),
                        'default'  => 'professors-page',
                        )
				),
            );
			...
			$this->sections[] = array(
                ...
                'fields'    => array(
					...
					array(
					 ...
					 array(
						'id'					=> 'sd_course_search_bg',
						'type'					=> 'color',
						'title'					=> __( 'Course Search Background', 'sd-framework' ), 
						'subtitle'				=> __( 'Select the course search box background color.', 'sd-framework' ),
						'desc'					=> __( 'Default is #0191c6', 'sd-framework' ),
						'transparent'			=> false,
						'compiler' 				=> array( 'background-color' => '.sd-search-courses' )
					),
					array(
						'id'					=> 'sd_course_search_title',
						'type'					=> 'color',
						'title'					=> __( 'Search Boxt Title', 'sd-framework' ), 
						'subtitle'				=> __( 'Select the course search box title color.', 'sd-framework' ),
						'desc'					=> __( 'Default is #ffffff', 'sd-framework' ),
						'transparent'			=> false,
						'compiler' 				=> array( '.sd-search-courses h2' )
					),
					array(
						'id'					=> 'sd_course_search_button',
						'type'					=> 'color',
						'title'					=> __( 'Search Box Button', 'sd-framework' ), 
						'subtitle'				=> __( 'Select the course search box button color.', 'sd-framework' ),
						'desc'					=> __( 'Default is #2a2e30', 'sd-framework' ),
						'transparent'			=> false,
						'compiler' 				=> array( 'background-color' => '.wpas-submit input' )
					),
					array(
						'id'					=> 'sd_course_search_button_text',
						'type'					=> 'color',
						'title'					=> __( 'Search Box Button Text', 'sd-framework' ), 
						'subtitle'				=> __( 'Select the course search box button text color.', 'sd-framework' ),
						'desc'					=> __( 'Default is #ffffff', 'sd-framework' ),
						'default'				=> '',
						'transparent'			=> false,
						'compiler' 				=> array( '.wpas-submit input' )
					),
					array(
