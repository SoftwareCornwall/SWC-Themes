						...
						<div class="flex-container">
							<div class="flex-item">
								<ul class="package">
									...
									<li class="gray">
									<?php echo do_shortcode('[wp_stripe_checkout_v3 price="price_1J5T7AAyX7phdOBZ8vuSbJTl" mode="subscription" button_text="Purchase" cancel_url="https://softwarecornwall.org/become-a-member/"]'); ?>
									</li>
								</ul>
							</div>
							<div class="flex-item">
								<ul class="package">
									...
									<li class="gray">
									<?php echo do_shortcode('[wp_stripe_checkout_v3 price="price_1JMVufAyX7phdOBZCsiR7iej" mode="subscription" button_text="Purchase" cancel_url="https://softwarecornwall.org/become-a-member/"]'); ?>
									</li>
								</ul>
							</div>
							<div class="flex-item">
